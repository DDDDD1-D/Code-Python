# -*- coding: utf-8 -*-
"""
Created on Tue Oct 20 16:51:12 2015
...
d=-10**6*pressure_file.variables['d'][:,lev_ind,:,:]
mask_ind=np.where(d<=0)
d[mask_ind]=0
...
for ii in range(ntimes):
    ...
    clevs=[-200,-80,-60,-40,-20,0,20,40,60,80,200]
    cs2=m.contourf(x,y,d[ii,0,:,:],clevs,cmap=plt.cm.RdBu_r)  #plt.cm.GnBu)
    cb = m.colorbar(cs2,"right", size="5%", pad='2%')
    cb.set_label('Convergence: $10^{-6}$')
